...
def main():
    ...
    def add_common_args(sub):
        sub.add_argument(
            "--output",
            default="datasets/interim/particles2SNR-pipeline/p0-baseline-candidate",
            help="Candidate output directory; register a new immutable version after validation",
        )
        ...
        sub.add_argument("--noise-dir", default="./datasets/processed/noise/v1", metavar="DIR",
