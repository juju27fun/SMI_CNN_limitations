...
Regenerates
``outputs/benchmarks/results/doublet_3fam_retrained/doublet_comparison_acc_latency.pdf``
...
_TRANSFORMER_DIR = (
    _PROJECT_ROOT / "outputs/benchmarks/results/doublet_transformers_retrained_lr1e4"
)
