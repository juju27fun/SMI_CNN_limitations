"""Benchmark 2 — Model Zoo (datasets/processed/p0-baseline-3class/v1, 3 classes).
...
Tiers 1-5 use datasets/processed/p0-baseline-3class/v1; tier 6 trains on synthetic and tests on real.
...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark 2: Model Zoo (datasets/processed/p0-baseline-3class/v1, 3 classes)"
    )
    add_common_training_args(parser, data_dir_default="datasets/processed/p0-baseline-3class/v1")

    # Override defaults for benchmark
    parser.set_defaults(patience=20, epochs=150, scheduler="cosine", output_dir="artifacts/SMI_CNN_limitations/benchmark2")
